...
CREATE INDEX idx_labels_session ON labels(session_id);
CREATE INDEX idx_labels_pose ON labels(pose_id);
CREATE INDEX idx_labels_timestamp ON labels(timestamp_sec);
CREATE INDEX idx_labels_frame ON labels(frame_id);
