...
from qt.generate_sky import SkyPointCloud
...
if __name__ == "__main__":
    ...
    #! 场景中心点假设为 (10, 20, 5)
    #! 生成 sky.ply 文件，供后续 3DGS 场景使用
    # temp_sky_ply_path = work_dir / "sparse/"
    # print(f"生成天空点云 : {temp_sky_ply_path / 'sky.ply'}")
    # sky = SkyPointCloud(num_points=500000, radius=10000, color=(135, 206, 250), center=(0, 0, 0))
    # sky.save_as_ply( temp_sky_ply_path / "sky.ply")
    # print(f"天空点云文件完成 : {temp_sky_ply_path / 'sky.ply'}")
    # exit(0)

    #! 启动子线程运行 06_nu_sampling
    #! 会生成 gs_init.ply 
