...
int main(int argc, char **argv)
{
  ...
  while (!g_bExit)
  {
    ...
    // mv_file = "mv /home/map/r3live_body_path.txt  /home/map/test/r3live_body_path_" + std::to_string(num) + ".txt ";
    std::string   mv_file = "mv  /home/map/fast_livo_body_path.txt  /home/map/fast_livo_body_path_" + std::to_string( num )  + ".txt ";
    ...
    if (num < 5)
    {
      ...
      system("source /opt/csg/SH100/slam/navs/devel/setup.bash; roslaunch fast_livo  mapping_v2_2nd.launch ");
